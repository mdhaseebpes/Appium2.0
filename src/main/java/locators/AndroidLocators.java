...
public class AndroidLocators {
    ...
    public static void main(String[] args) throws Exception {
        ...
        driver.findElement(AppiumBy.tagName(""));//cannot be used in native app as locator strategy
        //Xpath
        ...
        WebElement myElementUIAutomator0 = driver.findElement(AppiumBy.androidUIAutomator("new UiSelector().description(\"Content\")"));
        System.out.println(myElementUIAutomator0.getText());
       ...
       List<WebElement> myElementClickable = driver.findElements(AppiumBy.androidUIAutomator("new UiSelector().clickable(true)"));
        System.out.println("--------------");
        for(WebElement ele : myElementClickable){
